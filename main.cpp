...
/**
 * This is the main entry function to run and test the cellular automata quad tree that processing input
...
int main() {
    ...
    QuadTreeTests::RunRLEPatternTest("../patterns/mickeymouse.rle", 1, MinPowerOf2(16), MinPowerOf2(16), true);
    ...
    // This algorithm doesn't handle methuselah's particularly well
    ...
    QuadTreeTests::RunMegaRandomMaxBoundariesTest(1000, 100, MinPowerOf2(6), MaxPowerOf2(6), MinPowerOf2(6), MaxPowerOf2(6), true);

    // STRESS TEST: 200-300k cells initialized
    QuadTreeTests::RunMegaRandomMaxBoundariesTest(MaxPowerOf2(12) * MaxPowerOf2(10), 0, MinPowerOf2(9), MaxPowerOf2(9), MinPowerOf2(9), MaxPowerOf2(9), true);
